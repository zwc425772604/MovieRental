...
//            });
    ...
    <li <% if(((Employee)session.getAttribute("employeeData")).getPosition().equals("Customer Rep")) {%> hidden <%} %>><button class = "transcation" id = "obtain_sales_report" onclick="window.open('salesReport.jsp','_self');">Obtain Sales Report</button></li>
    <li <% if(((Employee)session.getAttribute("employeeData")).getPosition().equals("Customer Rep")) {%> hidden <%} %>><button class = "transcation" id = "list_all_movies" onclick="window.open('allMovie.jsp','_self');">List all movies</button></li>
    <li <% if(((Employee)session.getAttribute("employeeData")).getPosition().equals("Customer Rep")) {%> hidden <%} %>><button class = "transcation" id = "list_movies_by" onclick="window.open('managerSearch.jsp','_self');">List movie rentals</button></li>
    <li <% if(((Employee)session.getAttribute("employeeData")).getPosition().equals("Customer Rep")) {%> hidden <%} %>><button class = "transcation" id = "view_best_rep" onclick="window.open('bestRep.jsp','_self');">See Customer Rep that oversaw most rentals</button></li>
