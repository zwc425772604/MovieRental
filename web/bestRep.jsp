<%-- 
    Document   : bestRep
    Created on : May 4, 2017, 9:35:40 AM
    Author     : ZheLin
--%>
...
<html>
    <head>
        ...
        <title>Best Customer Representative</title>
    </head>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
         ...
         <% 
            ...
            try {
                    ...
                    String movie_by_type_sql = "SELECT Person.FirstName, Person.LastName, COUNT(Person.ID) AS OCCUR FROM Rental, Person WHERE Rental.EmployeeID = Person.ID GROUP BY Person.ID ORDER BY OCCUR DESC LIMIT 1";
