<%-- 
    ...
    Created on : May 4, 2017, 8:49:39 AM
    Author     : ZheLin
--%>
...
<html>
  ...
  <span><strong><span style="font-size: 14pt; font-family: Arial">
    <table border="0" cellpadding="0" cellspacing="0" style="font-size: 14pt; width: 100%;
        ...
        <tr>
        	<form name="myForm" action="managerResults.jsp" method="post">
            <td style="width: 220px; height: 426px; vertical-align: top; text-align: left;">
                ...
                <span style="font-size: 10pt"><strong>Customer:<br />
                    ...
                    <input id="Button1" type="button" value="Back" onclick="window.open('EmployeeInfoServlet','_self');" /><br />
