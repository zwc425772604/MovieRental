<%-- 
    Document   : recommendation2
    Created on : May 4, 2017, 10:30:50 AM
    Author     : ZheLin
--%>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
         ...
         <% 
            ...
            try {
                    ...
                    String query2 = "WHERE M.Genre IN (SELECT O.Genre FROM RentalHistory O WHERE O.AccountID = '"+ request.getParameter("cusID") + "') AND ";
                    String query3 = "M.ID NOT IN (SELECT O.MovieID FROM RentalHistory O WHERE O.AccountID = '"+ request.getParameter("cusID") + "')";
