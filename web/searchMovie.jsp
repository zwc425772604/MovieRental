...
<html>
  ...
  <span><strong><span style="font-size: 14pt; font-family: Arial">
    <table border="0" cellpadding="0" cellspacing="0" style="font-size: 14pt; width: 100%;
        ...
        <tr>
            <td colspan="2" style="height: 63px; text-align: center; background-color: yellow;">
                Search Movie</td>
        </tr>
        <tr>
        	<form name="myForm" action="searchMovieServlet" method="post">
            <td style="width: 220px; height: 426px; background-color: yellow; vertical-align: top; text-align: left;">
                ...
                <input name="movie_keyword" style="font-weight: bold; font-size: 10pt; width: 250px; left: 0px; position: relative; top: 0px;" type="text" /><br />
                <span style="font-size: 10pt">
               
                <span style="font-size: 10pt"><strong>Actor/Actors:<br />
                    <input name="movie_casted_actor" style="font-weight: bold; font-size: 10pt; width: 25px"
                        type="text" />
                    <br />
